...
library EntityType {
   ...
   * @notice Get value.
   */
  function getValue(bytes16 entityType) internal view returns (bytes32 value) {
   ...
   * @notice Get value.
   */
  function _getValue(bytes16 entityType) internal view returns (bytes32 value) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(entityType);
   ...
   * @notice Get value.
   */
  function get(bytes16 entityType) internal view returns (bytes32 value) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(entityType);
   ...
   * @notice Get value.
   */
  function _get(bytes16 entityType) internal view returns (bytes32 value) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(entityType);
   ...
   * @notice Set value.
   */
  function setValue(bytes16 entityType, bytes32 value) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(entityType);
   ...
   * @notice Set value.
   */
  function _setValue(bytes16 entityType, bytes32 value) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(entityType);
   ...
   * @notice Set value.
   */
  function set(bytes16 entityType, bytes32 value) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(entityType);
   ...
   * @notice Set value.
   */
  function _set(bytes16 entityType, bytes32 value) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(entityType);
