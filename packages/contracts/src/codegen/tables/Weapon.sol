...
library Weapon {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "Weapon", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74620000000000000000000000000000576561706f6e00000000000000000000);
