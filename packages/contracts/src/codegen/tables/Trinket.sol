...
library Trinket {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "Trinket", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000005472696e6b6574000000000000000000);
