...
library Armor {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "Armor", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462000000000000000000000000000041726d6f720000000000000000000000);
